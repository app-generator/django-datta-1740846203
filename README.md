...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-datta-1740846203) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-datta-1740846203.git
$ cd django-datta-1740846203
```
